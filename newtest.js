const mark1=document.getElementsByName('maths');
const mark2=document.getElementsByName('science');
const mark3=document.getElementsByName('structure');
const mark4=document.getElementsByName('oop');
const mark5=document.getElementsByName('digital');
const mark6=document.getElementsByName('pd');
const mark7=document.getElementsByName('dsclab');
const mark8=document.getElementsByName('dslab');
const mark9=document.getElementsByName('ooplab');
...
if(m1==null || m2==null || m3==null || m4==null || m5==null || m6==null || m7==null || m8==null || m9==null){
    alert("Please,Select All Subject Grade!!!");
}
else{
var credits=(m1*4)+(m2*3)+(m3*3)+(m4*3)+(m5*4)+(m6*1)+(m7*2)+(m8*1.5)+(m9*1.5)
...
var m1=m2=m3=m4=m5=m6=m7=m8=m9=null;
}